...
prg = "c:/Users/unhoc/Documents/copilot_pair/18_gematria/gematria.py"
...
def test_text():
    ...
    out = getoutput(f'{interpreter} {prg} "foo bar baz"')
...
def test_spiders():
    ...
    out = getoutput(f"{interpreter} {prg} {spiders}")
...
def test_sonnet():
    ...
    out = getoutput(f"{interpreter} {prg} {sonnet}")
    expected = """
631 107
719 1132
