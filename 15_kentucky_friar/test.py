...
prg = "c:/Users/unhoc/Documents/copilot_pair/15_kentucky_friar/friar.py"
...
def test_two_syllable_ing_words():
    ...
    for given, expected in tests:
        out = getoutput(f"{interpreter} {prg} {given}")
...
def run_file(file):
    ...
    out = getoutput(f"{interpreter} {prg} {file}")
    assert out.strip() == expected.strip()
...
def test_blake():
    ...
    run_file("c:/Users/unhoc/Documents/copilot_pair/15_kentucky_friar/inputs/blake.txt")
...
def test_banner():
    ...
    run_file(
        "c:/Users/unhoc/Documents/copilot_pair/15_kentucky_friar/inputs/banner.txt"
    )
...
def test_raven():
    ...
    run_file("c:/Users/unhoc/Documents/copilot_pair/15_kentucky_friar/inputs/raven.txt")
