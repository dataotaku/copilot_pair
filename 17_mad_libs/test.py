...
prg = "c:/Users/unhoc/Documents/copilot_pair/17_mad_libs/mad.py"

no_blanks = "c:/Users/unhoc/Documents/copilot_pair/17_mad_libs/inputs/no_blanks.txt"
fox = "c:/Users/unhoc/Documents/copilot_pair/17_mad_libs/inputs/fox.txt"
hlp = "c:/Users/unhoc/Documents/copilot_pair/17_mad_libs/inputs/help.txt"
verona = "c:/Users/unhoc/Documents/copilot_pair/17_mad_libs/inputs/romeo_juliet.txt"
...
def test_no_blanks():
    ...
    rv, out = getstatusoutput(f"{interpreter} {prg} {no_blanks}")
    assert rv != 0
...
def test_fox():
    ...
    rv, out = getstatusoutput(f"{interpreter} {prg} {args}")
    assert rv == 0
