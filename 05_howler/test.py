...
prg = "c:/Users/unhoc/Documents/copilot_pair/05_howler/howler.py"
...
def test_text_stdout():
    ...
    out = getoutput(
        f'c:/Users/unhoc/Documents/copilot_pair/.copilot_pair/Scripts/python.exe {prg} "foo bar baz"'
    )
...
def test_text_outfile():
    ...
    try:
        out = getoutput(
            f'c:/Users/unhoc/Documents/copilot_pair/.copilot_pair/Scripts/python.exe {prg} {out_flag()} {out_file} "foo bar baz"'
        )
        assert out.strip() == ""
...
def test_file():
    ...
    for expected_file in os.listdir("test-outs"):
        try:
            ...
            out = getoutput(
                f"c:/Users/unhoc/Documents/copilot_pair/.copilot_pair/Scripts/python.exe {prg} {out_flag()} {out_file} {in_file}"
            )
            assert out.strip() == ""
